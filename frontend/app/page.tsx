...
type Stats = {
  ...
  top_epss_cves: { cve_id: string; title: string | null; epss_score: number; epss_percentile: number | null }[];
};
...
export default async function DashboardPage() {
  const stats = await getJson<Stats>("/stats", { total_cves: 0, total_products: 0, latest_release: null, exploited_count: 0, publicly_disclosed_count: 0, total_kev_vulnerabilities: 0, average_epss_score: null, top_epss_cves: [] });
